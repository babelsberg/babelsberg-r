 ...
 *
 */
extern "C" Z3_ast my_mk_str_value(Z3_theory t, char const * str)
{
 ...
 *
 */
extern "C" Z3_ast my_mk_str_var(Z3_theory t, char const * name)
{
    Z3_context ctx = Z3_theory_get_context(t);
    PATheoryData * td = (PATheoryData *) Z3_theory_get_ext_data(t);
    Z3_ast varAst = mk_var(ctx, name, td->String);
    // Z3_symbol s = Z3_mk_string_symbol(ctx, name);
    // Z3_ast varAst = Z3_theory_mk_constant(ctx, t, s, td->String);
    ...
    switch (z3Kind)
    {
        ...
        case Z3_APP_AST:
        {
            if (Z3_theory_is_value(t, n))
            {
                ...
                if (d == td->Concat || d == td->Length || d == td->SubString || d == td->Contains || d == td->StartsWith
                        || d == td->EndsWith || d == td->Indexof || d == td->Replace)
                    return my_Z3_Func;
                else
 ...
 *
 */
extern "C" Z3_ast mk_length(Z3_theory t, Z3_ast n)
{
    Z3_context ctx = Z3_theory_get_context(t);
    PATheoryData * td = (PATheoryData*) Z3_theory_get_ext_data(t);
 ...
 *
 */
extern "C" Z3_ast mk_concat(Z3_theory t, Z3_ast n1, Z3_ast n2)
{
    Z3_context ctx = Z3_theory_get_context(t);
    PATheoryData * td = (PATheoryData*) Z3_theory_get_ext_data(t);
    if (n1 == NULL || n2 == NULL)
...
int canConcatEqConcat(Z3_theory t, Z3_ast concat1, Z3_ast concat2)
{
    ...
    if (isConcatFunc(t, concat1) && isConcatFunc(t, concat2))
    {
        ...
        if (getNodeType(t, concat1_mostL) == my_Z3_ConstStr && getNodeType(t, concat2_mostL) == my_Z3_ConstStr)
        {
            ...
            int cLen = (concat1_mostL_str.length() > concat2_mostL_str.length()) ?
...
//    {
        ...
        std::string fVarName = Z3_ast_to_string(ctx, n);
        int vBase = 0;
        for (int j = 0; j < (int)fVarName.length(); j++)
        {
            vBase += (int)fVarName[j];
        }
        vBase = vBase % freeVarAlphabetSize;


        for (int i = 0; i < freeVarMaxLen + 1; i++)
        {
            std::string tmp = "";
            for (int j = 0; j < i; j++)
            {
                tmp += freeVarAlphabet[vBase];
                vBase = (vBase + freeVarStep) % freeVarAlphabetSize;
//                tmp += "@";
            }
        ...
        and_items[pos1++] = Z3_mk_le(ctx, n_lenAst, mk_int(ctx, freeVarMaxLen));
...
//    std::pair<Z3_ast, Z3_ast> key22(new_nn2, new_nn1);
    ...
    //*************************************************************
    if ( (getNodeType(t, v1_arg0) == my_Z3_ConstStr && getNodeType(t, v1_arg1) != my_Z3_ConstStr && getNodeType(t, v2_arg0) != my_Z3_ConstStr && getNodeType(t, v2_arg1) == my_Z3_ConstStr)
       ||   (getNodeType(t, v2_arg0) == my_Z3_ConstStr && getNodeType(t, v2_arg1) != my_Z3_ConstStr
          && getNodeType(t, v1_arg0) != my_Z3_ConstStr && getNodeType(t, v1_arg1) == my_Z3_ConstStr))
    {
        __debugPrint(logFile, "\n");
 ...
 *
 */
extern "C" Z3_bool cb_final_check(Z3_theory t)
{
    Z3_context ctx = Z3_theory_get_context(t);
 ...
 *
 */
extern "C" Z3_bool cb_reduce_eq(Z3_theory t, Z3_ast s1, Z3_ast s2, Z3_ast * r)
{
    Z3_context ctx = Z3_theory_get_context(t);
 ...
 *
 */
extern "C" void cb_init_search(Z3_theory t)
{
#ifdef DEBUGLOG
    Z3_context ctx = Z3_theory_get_context(t);
    Z3_ast ctxAssign = Z3_get_context_assignment(ctx);
 ...
 *
 */
extern "C" Z3_ast reduce_subStr(Z3_theory t, Z3_ast const args[], Z3_ast & breakdownAssert)
{
    Z3_context ctx = Z3_theory_get_context(t);
 ...
 *
 */
extern "C" Z3_ast reduce_contains(Z3_theory t, Z3_ast const args[])
{
    Z3_context ctx = Z3_theory_get_context(t);
 ...
 *
 */
extern "C" Z3_ast reduce_startswith(Z3_theory t, Z3_ast const args[])
{
    Z3_context ctx = Z3_theory_get_context(t);
    Z3_ast reduceAst = NULL;
    if (getNodeType(t, args[0]) == my_Z3_ConstStr && getNodeType(t, args[1]) == my_Z3_ConstStr)
 ...
 *
 */
extern "C" Z3_ast reduce_endswith(Z3_theory t, Z3_ast const args[])
{
    Z3_context ctx = Z3_theory_get_context(t);
    Z3_ast reduceAst = NULL;
    if (getNodeType(t, args[0]) == my_Z3_ConstStr && getNodeType(t, args[1]) == my_Z3_ConstStr)
 ...
 *
 */
extern "C" Z3_ast reduce_indexof(Z3_theory t, Z3_ast const args[], Z3_ast & breakdownAssert)
{
    Z3_context ctx = Z3_theory_get_context(t);
    if (getNodeType(t, args[0]) == my_Z3_ConstStr && getNodeType(t, args[1]) == my_Z3_ConstStr)
    {
 ...
 *
 */
extern "C" Z3_ast reduce_replace(Z3_theory t, Z3_ast const args[], Z3_ast & breakdownAssert)
{
    Z3_context ctx = Z3_theory_get_context(t);
    if (getNodeType(t, args[0]) == my_Z3_ConstStr && getNodeType(t, args[1]) == my_Z3_ConstStr
 ...
 *
 */
extern "C" Z3_theory mk_pa_theory(Z3_context ctx)
{
#ifdef DEBUGLOG
    if (!logFile) logFile = fdopen(1, "a");
#endif
...
extern "C" Z3_sort my_get_String_sort(Z3_theory t)
{
    PATheoryData* d = (PATheoryData*)Z3_theory_get_ext_data(t);
    return d->String;
}

extern "C" Z3_ast my_mk_str_eq(Z3_theory t, Z3_ast l, Z3_ast r)
{
    Z3_context ctx = Z3_theory_get_context(t);
    Z3_ast out = Z3_mk_eq(ctx, l, r);
    if (cb_reduce_eq(t, l, r, &out) != Z3_TRUE) {
	return NULL;
    } else {
	return out;
    }
